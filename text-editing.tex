...
\label{sec:orgd4c8197}
\subsubsection{Character Movement}
\label{sec:orgd57814f}
\begin{enumerate}
\item Beginner
\label{sec:org99c3573}
\begin{itemize}
...
\caption{\label{fig:orgc8e27b0}
A graphical depiction of h, j, k, l}
\end{figure}
\end{enumerate}
\subsubsection{Line Movement}
\label{sec:orgab79be7}
\begin{enumerate}
\item Beginner
\label{sec:org926e814}
\begin{itemize}
...
\label{sec:org8f31d21}
\subsubsection{Beginner}
\label{sec:org4552cf7}
\begin{itemize}
...
\label{sec:org925d930}
\subsubsection{Beginner}
\label{sec:org229cec5}
...
\label{sec:org1b8bd55}
\subsubsection{Beginner}
\label{sec:org3e6bd7e}
