...
\label{sec:orgeb5b3b4}
\subsubsection{Character Movement}
\label{sec:orgec91781}
\begin{enumerate}
\item Beginner
\label{sec:org98c79e3}
\begin{itemize}
...
\caption{\label{fig:org4c279b7}
A graphical depiction of h, j, k, l}
\end{figure}
\end{enumerate}
\subsubsection{Line Movement}
\label{sec:org0b60966}
\begin{enumerate}
\item Beginner
\label{sec:orgf968a00}
\begin{itemize}
...
\label{sec:org0f7e04c}
\subsubsection{Beginner}
\label{sec:orgb88cdb6}
\begin{itemize}
...
\label{sec:org2e31432}
\subsubsection{Beginner}
\label{sec:org641b2f3}
...
\label{sec:orgce2bd3a}
\subsubsection{Beginner}
\label{sec:org4c946c1}
