...
\label{sec:orgf9b25a4}
\begin{enumerate}
\item Beginner
\label{sec:org0f39bd2}
\begin{itemize}
...
\label{sec:org63e1d40}
\begin{enumerate}
\item Beginner
\label{sec:org9fd7d6a}
\begin{itemize}
...
\label{sec:org4bad71c}
\begin{enumerate}
\item Beginner
\label{sec:orga3b583e}
...
\end{enumerate}
\section{Registers}
\label{sec:org7929eea}
\begin{enumerate}
\item Intermediate
\label{sec:orgf1cdcf8}
